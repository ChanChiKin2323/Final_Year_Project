...
const Dashboard = () => {
    ...
    const { shows, totalBookings, totalRevenue, totalUser } = useAdmin()
    ...
    const dashboardCards = [
        ...
        { title: "Active Shows", value: shows.length || "0", icon: PlayCircleIcon },
    ...
    return (
        <>
            ...
            <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
                ...
                {shows.length === 0 ? (
                    <p className="text-gray-400">No active shows yet. Add one from Add Shows.</p>
                ) : shows.map((show) => (
